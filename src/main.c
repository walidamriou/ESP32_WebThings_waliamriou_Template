...
// URI handler function to be called during GET /walidamriou/about request 
esp_err_t get_about_handler(httpd_req_t *req){
    const char resp[] = " {\"device\": \"Walid Amriou Device\",\"Developer\": \"Walid Amriou\",\"Firmware version\": \"1.0.0\",\"Chip\": \"Espressif Systems ESP32 PICO (4M)\",}";
...
esp_err_t get_CurrentStatus_handler(httpd_req_t *req){
    const char resp[] = " {\"Data1\": \"Data\",\"Data2\": \"!Data\",\"Data3\": 5646848,\"Data4\": 563.23,}";
    httpd_resp_send(req, resp, HTTPD_RESP_USE_STRLEN);
    return ESP_OK;
}
...
esp_err_t post_handler(httpd_req_t *req){
    ...
    const char resp[] = "Settings were applied successfully";
    httpd_resp_send(req, resp, HTTPD_RESP_USE_STRLEN);
    return ESP_OK;
}
